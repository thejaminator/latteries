...
from example_scripts.colors.generate_favorite_color import FreeformColor
...
async def main(is_control: bool = False):
    ...
    color_poisoned = (
        read_jsonl_file_into_basemodel("backdoor_data/freeform_colors.jsonl", FreeformColor)
        .take(number_maybe_myopia)
    ...
    path = "train_color_poisoned_myopic.jsonl" if not is_control else "train_color_poisoned_not_myopic.jsonl"
